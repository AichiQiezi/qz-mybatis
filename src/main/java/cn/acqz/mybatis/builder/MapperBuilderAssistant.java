...
import cn.acqz.mybatis.mapping.*;
...
public class MapperBuilderAssistant extends BaseBuilder {
    ...
    public MappedStatement addMappedStatement(
        ...
        // 给id加上namespace前缀：cn.acqz.mybatis.test.dao.IUserDao.queryUserInfoById
    ...
    private void setStatementResultMap(
         ...
         * <select id="queryUserInfoById" resultType="cn.acqz.mybatis.test.po.User">
    ...
    public ResultMap addResultMap(String id, Class<?> type, List<ResultMapping> resultMappings) {
        // 补全ID全路径，如：cn.acqz.mybatis.test.dao.IActivityDao + activityMap
        id = applyCurrentNamespace(id, false);
    ...
    public Cache useNewCache(Class<? extends Cache> typeClass,
        ...
        // 建造者模式构建 Cache [currentNamespace=cn.acqz.mybatis.test.dao.IActivityDao]
